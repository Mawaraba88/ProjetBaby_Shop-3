	...
	public void run(String... args) throws Exception {
		// Insertion des données Account
			...
			//Insertion des caétogoires
				...
				productRepo.save(new Product("C001", "Lit", 100, "https://zupimages.net/viewer.php?id=21/11/gwjw.jpg", new Date(),(new Category(1))));
				productRepo.save(new Product("C002", "Commodes", 100,"https://zupimages.net/viewer.php?id=21/11/m16d.jpg",new Date(),(new Category(1))));
				productRepo.save(new Product("C003", "Plan à langer", 100, "https://zupimages.net/viewer.php?id=21/11/yr3p.jpg", new Date(),(new Category(1))));
				productRepo.save(new Product("C004", "Linge et parrures de lit", 100, "https://zupimages.net/viewer.php?id=21/11/68pr.jpg", (new Date()),(new Category(1))));
				...
				productRepo.save(new Product("C006", "Matelas", 100,"https://zupimages.net/viewer.php?id=21/11/buaf.jpg", new Date(),(new Category(1))));
